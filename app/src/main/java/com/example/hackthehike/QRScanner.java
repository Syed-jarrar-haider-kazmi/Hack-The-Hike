...
public class QRScanner extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (CameraPermission) {
            ...
            Intent i =getIntent();
            int r= i.getIntExtra("scores",0);
           Boolean chk=i.getBooleanExtra("finish",false);
            ...
            mCodeScanner.setDecodeCallback(new DecodeCallback() {
                ...
                public void onDecoded(@NonNull @NotNull Result result) {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Intent i =new Intent(QRScanner.this, HikeGame.class);
                            i.putExtra("codes",result.getText());
                            i.putExtra("myscore",r);
                            i.putExtra("finish",chk);
